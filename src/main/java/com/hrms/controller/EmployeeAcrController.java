...
public class EmployeeAcrController {
	...
	public String saveEmployeeAcr(@ModelAttribute("EmployeeAcr")EmployeeAcr employeeAcr , Model model, HttpSession session, MultipartFile file,HttpServletRequest request)
	{
		if (session.getAttribute("username") == null) {
			return "redirect:" + "./";
		}
